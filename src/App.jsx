        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap", alignItems: "center" }}>
          ...
          {METRICAS.map(m => (
            <button key={m.k} onClick={() => setMetrica(m.k)} style={{
              padding: "5px 12px", borderRadius: 2, fontSize: 12, fontWeight: 700, cursor: "pointer",
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      ...
      <div style={{ background: P.card, border: `1px solid ${P.border}`, borderRadius: 4, padding: "14px 18px", marginBottom: 20, display: "flex", gap: 16, flexWrap: "wrap", alignItems: "flex-end" }}>
        ...
        <button onClick={() => { setTPolo("Todos"); setTEstab("Todos"); setTSEDesde(""); setTSEHasta(""); }}
          style={{ padding: "6px 14px", borderRadius: 2, fontSize: 12, fontWeight: 700, cursor: "pointer",
